...
package com.osbitools.ws.rest.core.shared.rest;
...
import com.osbitools.ws.rest.core.shared.common.CoreRestTestConstants;
...
public abstract class CoreAppSharedTestUnit extends SharedRestBaseTestUnit {
  ...
  static {
    ...
    rparams.put("csv_filter_params",
        "date_from=01/01/2007&" + "date_to=12/31/2007&num_from=4&num_to=6");
  ...
  private final static String[][] STATIC_TEST_DEMO = new String[][] {
      ...
      new String[] { "csv_filter_complex",
          ...
          "{\"columns\":[" +
              "{\"name\":\"CDATE\",\"java_type\":\"java.util.Date\",\"on_error\":\"\"}," +
      ...
      new String[] { "csv_filter_complex_no_header",
          ...
          "{\"columns\":[" +
              "{\"name\":\"COL4\",\"java_type\":\"java.util.Date\"," +
              "\"on_error\":\"\"}," +
      ...
      new String[] { "csv_filter_params",
          ...
          "{\"columns\":[" +
              ...
              "\"java_type\":\"java.util.Date\",\"is_mandatory\":false}," +
  ...
  private final static String[][] STATIC_TEST_BAD = new String[][] {
      ...
      new String[] { "static_test_calc_bad3",
          ...
          "@\\{\"request_id\":\\d+,\"error\":" +
              ...
              "\\\\n                \\\\t\\\\t\\\\t\\\\t\\\\t\\\\t@\\{COL2\\}\\*@\\{COL2\\} '\"," +
              "\"Line 1, Column 10: Binary numeric promotion not possible on types" +
