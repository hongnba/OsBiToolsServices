...
public class DsDaemonTest extends AbstractResourceDaemonTest<DataSetDescr, DsDescrResource> {
  ...
  @Autowired
  @Qualifier("dcheck")
  public void setDsFilesCheckRef(AbstractResourceCheck<DataSetDescr, DsDescrResource> check) {
    initCheckRef(check);
  }
  ...
  public static final String STR_STATIC_TEST_LMAP_GRP_COMPLEX_1 =
      "{\"columns\":[" + "{\"name\":\"COL1\",\"java_type\":\"java.lang.String\"}," +
          "{\"name\":\"CNT\",\"java_type\":\"java.lang.Integer\"}]," + "\"data\":[" +
  ...
  public static final String STR_STATIC_TEST_GROUP_MIXED = "{\"columns\":[" +
  ...
  public static final String STR_STATIC_TEST_CALC_DATE1 = "{\"columns\":[" +
      ...
      "[2,11,1996,824014800000,\"2/11/1996\"]," + "[3,13,1997,858229200000,\"3/13/1997\"]," +
      "[4,15,1998,892612800000,\"4/15/1998\"]," + "[5,17,1999,926913600000,\"5/17/1999\"]," +
      "[6,19,2000,961387200000,\"6/19/2000\"]," + "[7,21,2001,995688000000,\"7/21/2001\"]," +
      "[8,23,2002,1030075200000,\"8/23/2002\"]," + "[9,25,2003,1064462400000,\"9/25/2003\"]," +
  ...
  public static final String STR_STATIC_TEST_CALC_DATE2 =
      "{\"columns\":[" + "{\"name\":\"COL1\",\"java_type\":\"java.util.Date\"}," +
          "{\"name\":\"COL2\",\"java_type\":\"java.lang.String\"}]," +
          "\"data\":[[978238800000,\"[978238800000]\"]" + "]}";
  ...
  public static final String CSV_FILTER_COMPLEX =
      "{" + "\"columns\":[" + "{\"name\":\"CSTR\",\"java_type\":\"java.lang.String\"}," +
          ...
          "\"data\":[[\"ewB\",\"4\",4.5204705669907845,1170478800000]," +
          "[\"хдд\",\"7\",4.166499351125718,1179460800000]," +
          "[\"ааА\",\"0\",5.363522439789376,1187150400000]]}";
  ...
  public static final String SQL_SELECT_COND =
      "{" + "\"columns\":[" + "{\"name\":\"CSTR\",\"java_type\":\"java.lang.String\"}," +
          "{\"name\":\"CINT\",\"java_type\":\"java.lang.Integer\"}," +
          "{\"name\":\"CNUM\",\"java_type\":\"java.lang.Double\"}," +
          "{\"name\":\"CDATE\",\"java_type\":\"java.util.Date\"}]," + "\"data\":[" +
          "[\"BBa\",3,6.363432849109767,\"2008-08-24\"]," +
          "[\"аАА\",3,1.8543233750941412,\"2007-12-12\"]," +
          "[\"бББ\",3,2.0654223581606,\"2008-07-03\"]," +
          "[\"Bbb\",3,5.229165495026457,\"2010-06-12\"]," +
  ...
  public DsDaemonTest() {
    super(DBMAP_ALIAS, DataSetDescr.class, new String[] { "ds_empty.xml", "ds.xml" }, _fname,
        _ds_cfg);
  }
  ...
  public static void setUpBeforeClass() throws Exception {
    ...
    File tcsv = new File(CoreSharedTestConstants.WORK_TEST_PROJ + File.separator + "csv");
    ...
    for (String fname : flist)
      JarTestResourceUtils.copyDemoFileToFile(
          ...
          CoreSharedTestConstants.WORK_TEST_PROJ + File.separator + "csv" + File.separator +
              fname,
          _ds_cfg);
    ...
    if (!td.exists() && !td.mkdir())
      fail("Unable create " + CoreSharedTestConstants.WORK_BAD_PROJ + " directory.");
  ...
  public void loadDefLsFile() throws Exception {
    ...
    JarTestResourceUtils.copyDemoFileToFile(LsConstants.LANG_SET_FILE + "_combo",
        CoreSharedTestConstants.LS_SET_TEST_FILE_PATH, LangLabelsDaemonTest.LS_CFG);
    ...
    assertNotNull("'" + CoreSharedTestConstants.TEST_LS_FILE_KEY + "' is not loaded " +
        "after " + TestConstants.WAIT_TIME + " msec of waiting.", lsr);
  ...
  public void initTest() {
    ...
    // Initial check
    AbstractResourceCheck<DataSetDescr, DsDescrResource> _dcheck = getCheckRef();
  ...
  public void testStaticTestLmapMinifiedGrpComplex1() throws Exception {
    testFile("static_test_lmap_grp_complex1", true, STR_STATIC_TEST_LMAP_GRP_COMPLEX_1);
  }

  @Test
  public void testStaticTestLmapMinifiedGrpComplex2() throws Exception {
    testFile("static_test_lmap_grp_complex2", true, STR_STATIC_TEST_LMAP_GRP_COMPLEX_2);
  }

  @Test
  public void testStaticTestLmapMinifiedGrpComplex3() throws Exception {
    testFile("static_test_lmap_grp_complex3", true, STR_STATIC_TEST_LMAP_GRP_COMPLEX_3);
  }
  ...
  public void testStaticTestLmapNonMinified() throws Exception {
    testStaticFile("static_test_lmap", false, STR_STATIC_TEST_LMAP_NON_MINIFIED_NO_TRACE,
        false);
    ...
    testFile("static_test_lmap", false, STR_STATIC_TEST_LMAP_NON_MINIFIED, false);

    trace.getEventsList().clear();

    testFile("static_test_lmap_grp_single", false, STR_STATIC_TEST_LMAP_GRP_NON_MINIFIED,
        false);

    warn = null;
    trace.setEnabled(false);
    testFile("static_test_lmap_grp_multi", false, STR_STATIC_TEST_LMAP_EX_NON_MINIFIED, false);
  }

  @Test
  public void testStaticTestLmapNonMinifiedComplex() throws Exception {
    testFile("static_test_lmap_grp_complex3", true, STR_STATIC_TEST_LMAP_COMPLEX_NON_MINIFIED,
        false);
  }
  ...
  public void testStaticCalcBad(String falias, int errCode, int errMsgCnt) throws Exception {
    try {
  ...
  public void testStaticFile(String falias, boolean complex, String res, boolean minified)
      throws IOException, InterruptedException, WsSrvException {
    DsDescrResource dsr = loadTestFile(falias);

    StaticDataSetProc sdsp =
        new StaticDataSetProc(new DsExtResource(dsr.getResource()), null, _rlog);
    sdsp.setDsDescrResource(dsr);
    StaticDataSetProducer sdpr = new StaticDataSetProducer(sdsp, _lcheck, _cfg);

    DataSet ds = sdpr.read(CoreSharedTestConstants.TEST_PRJ_PREFIX + falias + ".xml",
        TestConstants.DEFAULT_LANG, trace, warn);
  ...
  public void testStaticTestStr2() throws Exception {
    ...
    DataSet ds = jdsp.read(CoreSharedTestConstants.TEST_PRJ_PREFIX + falias + ".xml", null,
        TestConstants.DEFAULT_LANG, trace, warn, _lcheck, _cfg);
    assertEquals(falias, STR_STATIC_TEST_STR_SORTED, mapper.writeValueAsString(ds));
  }
  ...
  public void testCsvFilterComplexNoHeader() throws Exception {
    testFile("csv_filter_complex_no_header", true, CSV_FILTER_COMPLEX_NO_HEADER);
  }
  ...
  public void testSqlFilterComplex() throws Exception {
    ...
    testSqlFile("sql_filter_complex", true, SQL_FILTER_COMPLEX, params, _ds, sparams);
  }

  private void testFile(String falias, boolean complex, String res) throws Exception {
    testFile(falias, complex, res, null, true);
  }

  private void testFile(String falias, boolean complex, String res, boolean minified)
      throws Exception {
  ...
  private void testFile(String falias, boolean complex, String res,
    ...
    testFile(falias, CoreSharedTestConstants.TEST_PRJ_NAME, complex, res, params, minified);
  }

  private void testBad(String falias, boolean complex, String res) throws Exception {
    testBad(falias, complex, res, true);
  }

  private void testBad(String falias, boolean complex, String res, boolean minified)
      throws Exception {
    testFile(falias, CoreSharedTestConstants.BAD_PRJ_NAME, complex, res, null, minified);
  }

  private void testFile(String falias, String prefix, boolean complex, String res,
      HashMap<String, Object> params, boolean minified) throws Exception {
  ...
  private void testSqlFile(String falias, boolean complex, String res,
      HashMap<String, Object> params, DataSource ds, Map<String, String[]> sparams)
      throws Exception {
    ...
    DataSet dst = jdsp.read(CoreSharedTestConstants.TEST_PRJ_PREFIX + falias + ".xml", sparams,
        TestConstants.DEFAULT_LANG, trace, warn, _lcheck, _cfg);
  ...
  private DsDescrResource loadJarFile(String prefix, String falias)
    ...
    JarTestResourceUtils.copyDemoFileToFile(prefix + "/" + falias,
        CoreSharedTestConstants.WORK_DS_PATH + prefix + File.separator + falias, _ds_cfg);
    ...
    assertNotNull("'" + falias + "' is not loaded after " + TestConstants.WAIT_TIME +
        " msec of waiting.", dsr);
  ...
  protected DsDescrResource checkPartialTestResourceLoaded() throws Exception {
    ...
    // Check for complex
    XmlDataSetProc dgp = new XmlDataSetProc(new DsExtResource(dsr.getResource()), null, _rlog);
    dgp.initComplex();
