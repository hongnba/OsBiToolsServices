 ...
 * 
 */
public class IconFileInfo implements IExFileInfo<String> {

  @Override
  public String getSaveInfo(File f, Map<String, String> params)
      throws WsSrvException {
    return "{\"base64\":\"" + new String(Base64.getEncoder().encode(
