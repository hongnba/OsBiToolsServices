...
public class ProjectController extends BaseController {
  ...
  private static final String BASE_PATH =
      CommonConstants.BASE_URL + "/projects";

  private static final String NAME_PATH =
      BASE_PATH + RestBaseConstants.PATH_SHORT_NAME_PARAM;
  ...
  protected void createProject(@PathVariable("name") String name)
      throws WsSrvException {
  ...
  @RequestMapping(value = NAME_PATH, method = RequestMethod.GET,
      produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
  public String[] getProjectEntities(@PathVariable("name") String name)
      throws WsSrvException {
   ...
   */
  @RequestMapping(
      value = NAME_PATH + "/{name_to:" + RestBaseConstants.ENTITY_NAME_REGEX +
          "}",
  ...
  public void deleteProject(@PathVariable("name") String name)
      throws WsSrvException {
