...
public class AbstractExFileController<T> extends BasePrjController {
  ...
  protected static final String SRV_BASE_URL =
      CommonConstants.BASE_URL + "/ex_files/";

  protected static final String DNAME_REGEX =
      "{dname:" + RestBaseConstants.ENTITY_NAME_REGEX + "}";

  protected static final String FNAME_REGEX =
      "{fname:" + RestBaseConstants.ENTITY_NAME_REGEX;

  protected static final String SRV_PATH_SET = DNAME_REGEX + "/" + FNAME_REGEX +
      "\\." + RestBaseConstants.ENTITY_NAME_REGEX + "\\." +
      PrjMgrRestConstants.FILE_EXT_REGEX + "}";

  @Autowired
  private ExFileService<T> _exfile;

  @RequestMapping(value = SRV_BASE_URL + SRV_PATH_SET,
  ...
  public T processExFile(@PathVariable("dname") String dname,
    ...
    T exFile =
        _exfile.createFile(dname, fname, in, 
  ...
  public void downloadExFile(@PathVariable("dname") String dname,
      @PathVariable("fname") String fname, HttpServletResponse resp)
  ...
  public void deleteExFileInfo(@PathVariable("dname") String dname,
    ...
    if (!f.delete())
      //-- 292
      throw new WsSrvException(292,
          "Error deleting file '" + f.getAbsolutePath() + "'");
  }
